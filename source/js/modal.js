for (var btn__order = document.querySelectorAll(".btn__order"), popup = document.querySelector(".modal__order"), overlay = document.querySelector(".modal__overlay"), i = 0; i < btn__order.length; i++)
